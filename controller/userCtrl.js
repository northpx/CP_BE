...
const forgotPasswordToken = asyncHandler(async (req,res) =>{
    ...
    try {
        ...
        await user.save();
        const resetURL = `Hi, Please follow this link to reset password. This link is valid till 10 minutes from now <a href='http://localhost:3000/reset-password/${token}'>Click here</a>`;
        const data = {
            to: email,
            text: "Hey User",
...
const removeProdFromCart = asyncHandler(async (req, res)=>{
    ...
    validateMongodbId(_id);
    try {
        const deleteProdCart = await Cart.deleteOne({userId: _id, _id: cartItemId})
...
module.exports = { createUser, loginUser, getAllUser, getUser, deleteUser, updateUser, blockUser, unblockUser, handleRefreshToken, logOut, updatePassword, forgotPasswordToken, resetPassword, loginAdmin, getWishlist, saveAddress, userCart, getUserCart, removeProdFromCart, updateProdQuantityFromCart, createOrder, getMyOrders, getOrders }